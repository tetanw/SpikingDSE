...
public class Validator
{
    public void Run()
    {
        ...
        for (int i = 0; i < 2264; i++)
        {
            ...
            var exp1 = new MultiCoreV1(false, null, inputFile1.Correct, srnn1, mapping, 100_000_000, 16_384);
            exp1.Run();

            var inputFile2 = new InputTraceFile($"res/shd/input_{i}.trace", 700, 100);
            var srnn2 = srnn.Copy(inputFile2);
            var exp2 = new ProtoMultiCore(false, inputFile2.Correct, srnn2, 100_000_000, 16_384);
            exp2.Run();
