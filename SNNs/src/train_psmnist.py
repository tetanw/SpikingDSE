...
PS_MNIST = np.load("data/psmnist.npz")

train_X = PS_MNIST["train_x"]
train_y = PS_MNIST["train_y"]

test_X = PS_MNIST["test_x"]
test_y = PS_MNIST["test_y"]
...
hidden_dim = [64, 64]
output_dim = 20
seq_dim = 28*14  # Number of steps to unroll
