...
model = SRNN2([
    ...
    ALIFLayer(40, 256, tau_m=4.0, tau_adp=10.0),
    ALIFLayer(256, 128, tau_m=4.0, tau_adp=10.0),
...
train(model, "psmnist-2", 30, input_dim, seq_dim, train_loader, test_loader, device, criterion, scheduler, optimizer)
