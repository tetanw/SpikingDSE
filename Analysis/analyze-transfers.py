...
plot_router_traffic(2, 1, "core6", ax[2][1])
plot_router_traffic(3, 0, "core7", ax[3][0])
plot_router_traffic(3, 1, "core8", ax[3][1])
plot_router_traffic(4, 0, "core9", ax[4][0])
plot_router_traffic(4, 1, "core10", ax[4][1])
plt.show()
...
plot_router_dirs(4, 0, "core9", ax[4][0])
plot_router_dirs(4, 1, "core10", ax[4][1])
